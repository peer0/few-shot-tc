...
### code_complex
n_labeled_per_class = sys.argv[1] #few shot 수
bs = 7  # 4, 8 # batch size
...
psl_threshold_h = sys.argv[4] # ul의 predict의 임계값
...
early_stop_tolerance = sys.argv[5]
p_tolerance = 10
max_step = 100000   
...
save_name = "{}_{}_{}_{}_{}_{}".format(n_labeled_per_class,net_arch.split('/')[1],lr,psl_threshold_h,early_stop_tolerance,dataset.split('/')[3])
