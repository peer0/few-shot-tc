...
def oneRun(log_dir, output_dir_experiment, **params):
    ...
    try:
        ...
        ul_data_path = root + 'data/' + 'code_contests'
        print('\ndata_path: ', data_path)
    except:
    ...
    #### Load Data ####
    from utils.dataloader_full import get_dataloader
    train_labeled_loader, train_unlabeled_loader, dev_loader, test_loader, n_classes = get_dataloader(data_path, ul_data_path, n_labeled_per_class, bs, load_mode)
    ...
    for epoch in range(max_epoch):
        ...
        for batch_label in train_labeled_loader:
            ...
            if load_mode == 'semi':
                #ul_ratio
                for _ in range(len(train_unlabeled_loader)):
