...
net_arch = ['Salesforce/codet5p-110m-embedding','Salesforce/codet5p-110m-embedding','Salesforce/codet5p-110m-embedding']

device_idx = 0
experiment_home = './experiment/cc_java_triple_pb'
