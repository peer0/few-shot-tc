...
def oneRun(output_dir_path, **params):
    ...
    best_csv_path = output_dir_path + 'summary.csv'
    ...
    for plot_type in plot_types:
        ...
        plt.legend()
        plt.savefig(output_dir_path+plot_type+'.png', bbox_inches='tight')
    ...
    plt.savefig(output_dir_path+'confmat_norm.png', bbox_inches='tight')
    df_cm.to_csv(output_dir_path+'confmat.csv', index=True, header=True)
