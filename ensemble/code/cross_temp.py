...
def train_one_epoch(netgroup, num_nets, train_labeled_loader, train_unlabeled_loader, device):
    netgroup.train()
    total_sup_loss = 0.0
...
def train(output_dir_path, seed, params):
    ...
    for epoch in range(params["max_epoch"]):
        ...
        train_loss = train_one_epoch(netgroup, params['num_nets']+1, train_labeled_loader, train_unlabeled_loader, device)
